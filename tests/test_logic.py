...
from tablet_sync_epub.app import EBookSyncApp, KOBO_SYS, ANDROID_SYS
...
class TestEBookSyncLogic(unittest.TestCase):
    def setUp(self):
        ...
        self.app.kobo_path.set(str(self.device_dir))

    def tearDown(self):
        self.root.destroy()
        shutil.rmtree(self.test_dir)

    def test_kobo_path_validation(self):
        self.assertTrue(self.app.is_kobo_path_valid(str(self.device_dir)))
        self.assertFalse(self.app.is_kobo_path_valid("Z:/NonExistentPath"))
